...
usage:
	blender blank.blend --background --python render_model_views.py -- <shape_obj_filename> <shape_view_param_file> <output_prefix> <syn_img_output_folder>
